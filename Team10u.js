...
const Team10u = ({ children }) => {
  ...
  const fetchTeam = () => {
    //    fetch(`http://softball-pi4/db/GetTravelCoaches10U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelTeam10U.php`)
    .then(async resp => {
  ...
  const fetchCoaches = () => {
//    fetch(`http://softball-pi4/db/GetTravelCoaches10U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelCoaches10U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const fetchPlayers = () => {
//      fetch(`http://softball-pi4/db/GetTravelPlayers10U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelPlayers10U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const fetchSchedule = () => {
//      fetch(`http://softball-pi4/db/GetTravelSchedule10U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelSchedule10U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const fetchNews = () => {
//      fetch(`http://softball-pi4/db/GetTravelNews10U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelNews10U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const handleEventClick = (info) => {
    ...
    <div>
      ...
      <Tabs defaultActiveKey={0} aria-label="Team10U-Tabs" role="tab">
        <Tab eventKey={0} title={<TabTitleText>Coaches</TabTitleText>} aria-label="10U-Coaches-Tab">
        {coachLoading && (
  		    <Bullseye>
	  	      <Spinner size="xl" />
		      </Bullseye>
        ...
        <Tab eventKey={1} title={<><TabTitleIcon><UsersIcon /></TabTitleIcon><TabTitleText>Players</TabTitleText></>} aria-label="10U-Players-Tab">
          {playerLoading && (
    		    <Bullseye>
	    	      <Spinner size="xl" />
		        </Bullseye>
          ...
          {!playerLoading && playerData?.length === 0 && (
            <Bullseye>
              <EmptyState titleText="10U Players not found" headingLevel="h5" icon={SearchIcon}>
                <EmptyStateBody>
                  Check your network connection or contact the system administrator.
                </EmptyStateBody>
              </EmptyState>
        ...
        <Tab eventKey={2} title={<><TabTitleIcon><CalendarIcon /></TabTitleIcon><TabTitleText>Schedule</TabTitleText></>} aria-label="10U-Schedule-Tab">
        {scheduleLoading && (
    		    <Bullseye>
	    	      <Spinner size="xl" />
		        </Bullseye>
          ...
          {!scheduleLoading && scheduleData?.length === 0 && (
            <Bullseye>
              <EmptyState titleText="Schedule for 10U not found" headingLevel="h5" icon={SearchIcon}>
                <EmptyStateBody>
                  Check your network connection or contact the system administrator.
                </EmptyStateBody>
              </EmptyState>
        ...
        <Tab eventKey={3} title={<><TabTitleIcon><NewsIcon /></TabTitleIcon><TabTitleText>News</TabTitleText></>} aria-label="10U-News-Tab">
        {newsLoading && (
    		    <Bullseye>
	    	      <Spinner size="xl" />
		        </Bullseye>
          ...
          {!newsLoading && newsData?.length === 0 && (
            <Bullseye>
              <EmptyState titleText="News for 10U not found" headingLevel="h5" icon={SearchIcon}>
                <EmptyStateBody>
                  Check your network connection or contact the system administrator.
                </EmptyStateBody>
              </EmptyState>

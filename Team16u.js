...
const Team16u = ({ children }) => {
  ...
  const fetchTeam = () => {
    //    fetch(`http://softball-pi4/db/GetTravelCoaches16U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelTeam16U.php`)
    .then(async resp => {
  ...
  const fetchCoaches = () => {
//    fetch(`http://softball-pi4/db/GetTravelCoaches16U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelCoaches16U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const fetchPlayers = () => {
//      fetch(`http://softball-pi4/db/GetTravelPlayers16U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelPlayers16U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const fetchSchedule = () => {
//      fetch(`http://softball-pi4/db/GetTravelSchedule16U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelSchedule16U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const fetchNews = () => {
//      fetch(`http://softball-pi4/db/GetTravelNews16U.php`)
    fetch(`https://www.ehtsoftball.com/db/GetTravelNews16U.php`)
    .then(async resp => {
      const jsonResponse = await resp.json()
  ...
  const handleEventClick = (info) => {
    ...
    >
      <ModalHeader title={<Label color="green">Strothers 16U Events</Label>} description={eventTitle} descriptorId="events-description" labelId="events-description" />
      <ModalBody>
      ...
      <Tabs defaultActiveKey={0} aria-label="Team16U-Tabs" role="tab">
        <Tab eventKey={0} title={<TabTitleText>Coaches</TabTitleText>} aria-label="16U-Coaches-Tab">
        {coachLoading && (
  		    <Bullseye>
	  	      <Spinner size="xl" />
		      </Bullseye>
        ...
        <Tab eventKey={1} title={<><TabTitleIcon><UsersIcon /></TabTitleIcon><TabTitleText>Players</TabTitleText></>} aria-label="16U-Players-Tab">
          {playerLoading && (
    		    <Bullseye>
	    	      <Spinner size="xl" />
		        </Bullseye>
          ...
          {!playerLoading && playerData?.length === 0 && (
            <Bullseye>
              <EmptyState titleText="16U Players not found" headingLevel="h5" icon={SearchIcon}>
                <EmptyStateBody>
                  Check your network connection or contact the system administrator.
                </EmptyStateBody>
              </EmptyState>
        ...
        <Tab eventKey={2} title={<><TabTitleIcon><CalendarIcon /></TabTitleIcon><TabTitleText>Schedule</TabTitleText></>} aria-label="16U-Schedule-Tab">
        {scheduleLoading && (
    		    <Bullseye>
	    	      <Spinner size="xl" />
		        </Bullseye>
          ...
          {!scheduleLoading && scheduleData?.length === 0 && (
            <Bullseye>
              <EmptyState titleText="Schedule for 16U not found" headingLevel="h5" icon={SearchIcon}>
                <EmptyStateBody>
                  Check your network connection or contact the system administrator.
                </EmptyStateBody>
              </EmptyState>
        ...
        {newsLoading && (
          ...
          {!newsLoading && newsData?.length === 0 && (
            <Bullseye>
              <EmptyState titleText="News for 16U not found" headingLevel="h5" icon={SearchIcon}>
                <EmptyStateBody>
                  Check your network connection or contact the system administrator.
                </EmptyStateBody>
              </EmptyState>
